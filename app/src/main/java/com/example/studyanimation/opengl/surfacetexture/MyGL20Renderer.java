...
public class MyGL20Renderer implements GLSurfaceView.Renderer {
    ...
    private int Height;
    private int count=0;
    MainCameraGLActivity delegate;
    public MyGL20Renderer(MainCameraGLActivity _delegate) {
        delegate = _delegate;
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(count <10){
            ...
            @SuppressLint("StaticFieldLeak") AsyncTask<Bitmap, Void, Boolean> task = new AsyncTask<Bitmap, Void, Boolean>(){
